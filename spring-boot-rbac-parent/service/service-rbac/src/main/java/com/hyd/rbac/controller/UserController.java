...
public class UserController {
    ...
    public Response index(
        ...
        return Response.success().data("items", pageModel.getRecords()).data("total", pageModel.getTotal());
    }
    ...
    public Response toAssign(@PathVariable String userId) {
        ...
        return Response.success().data(roleMap);
    }

    @ApiOperation(value = "根据用户分配角色")
    @PostMapping("/doAssign")
    public Response doAssign(@RequestParam String userId,@RequestParam String[] roleId) {
